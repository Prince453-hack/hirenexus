<?php partialView("head") ?>
<!-- Nav -->
<?php partialView("navbar") ?>
<!-- Top Banner -->
        ...
        <form method="POST" action="/listings">
            ...
            <?php if (isset($errors)) : ?>
                <?php foreach ($errors as $error) : ?>
                    <div class="message bg-red-100 my-3 py-2 px-2"><?= $error ?></div>
                <?php endforeach; ?>
            <?php endif; ?>
            <div class="mb-4">
            ...
            <div class="mb-4">
                <input type="text" name="benefits" placeholder="Benefits" class="w-full px-4 py-2 border rounded focus:outline-none" value="<?= $listing['company'] ?? '' ?>" />
            </div>
            <h2 class=" text-2xl font-bold mb-6 text-center text-gray-500">
